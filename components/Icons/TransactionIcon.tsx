...
export function svgTransactionIcon() {
  return (
    <svg
...
export const TransactionIcon = (props: any) => (
  <Icon component={svgTransactionIcon} {...props} />
);
